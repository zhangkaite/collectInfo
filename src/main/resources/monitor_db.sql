...
CREATE TABLE `diskinfo` (
  ...
  `usePercent` varchar(100) DEFAULT NULL,
  `diskReads` varchar(100) DEFAULT NULL,
  `diskWrites` varchar(100) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `netinfo` (
  ...
  `ip` varchar(50) DEFAULT NULL,
  `mac` varchar(50) DEFAULT NULL,
  `netNo` varchar(50) DEFAULT NULL,
  `netmask` varchar(50) DEFAULT NULL,
  `rxPackets` varchar(100) DEFAULT NULL,
  `txPackets` varchar(100) DEFAULT NULL,
  `rxBytes` varchar(100) DEFAULT NULL,
  `txBytes` varchar(100) DEFAULT NULL,
  `rxErrors` varchar(100) DEFAULT NULL,
  `txErrors` varchar(100) DEFAULT NULL,
  `rxDropped` varchar(100) DEFAULT NULL,
  `txDropped` varchar(100) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `sysinfo` (
  ...
  `cpuEndian` varchar(100) DEFAULT NULL,
  `dataModel` varchar(100) DEFAULT NULL,
  `description` varchar(100) DEFAULT NULL,
  `vendor` varchar(100) DEFAULT NULL,
  `vendorCodeName` varchar(100) DEFAULT NULL,
  `vendorName` varchar(100) DEFAULT NULL,
  `vendorVersion` varchar(100) DEFAULT NULL,
